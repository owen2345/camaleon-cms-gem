...
class FrontendController < CamaleonController
  ...
  def init_frontent
    ...
    self.prepend_view_path(Rails.root.join(views_dir = "app/apps/themes/#{current_theme.slug}/views").to_s)
    self.prepend_view_path(Rails.root.join(views_site_dir = "app/apps/themes/#{current_site.id}/views").to_s)
